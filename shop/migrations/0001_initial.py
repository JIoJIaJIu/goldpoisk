...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'shop_shop', (
            ...
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Admin'])),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Manager'])),
        ))
        db.send_create_signal(u'shop', ['Shop'])

        # Adding model 'Admin'
        db.create_table(u'shop_admin', (
            (u'user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'shop', ['Admin'])

        # Adding model 'Manager'
        db.create_table(u'shop_manager', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'shop', ['Manager'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'shop_admin')

        # Deleting model 'Manager'
        db.delete_table(u'shop_manager')
